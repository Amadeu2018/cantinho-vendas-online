  ...
  const fishDishes = [
    {
      ...
      description:
        "Corvina, piazete, garoupa - grelhados na perfeição com temperos especiais da casa",
      image:
        "https://amogastronomiabrasileira.com.br/wp-content/uploads/2023/09/Peixe-Assado-no-Forno.jpg",
      specialty: "Especialidade da Casa",
    },
    {
      title: "Cozido de Peixe",
      description:
        "Filetes de pescadas cozidos com temperos especiais e acompanhamentos tradicionais",
      image:
        "https://receitasdepesos.com.br/wp-content/uploads/2024/09/file-de-peixe-assado2.jpg.webp",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto animate-fade-in leading-relaxed">
            Especializamo-nos em pratos de peixe fresco, preparados com técnicas
            tradicionais e ingredientes selecionados. Cada prato conta uma
            história de sabor autêntico.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {fishDishes.map((dish, index) => (
            <Card
              key={index}
              className="hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 animate-scale-in overflow-hidden group"
            >
              <CardContent className="p-0">
                ...
                <div className="p-8">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-2xl font-bold text-cantinho-navy">
                      {dish.title}
                    </h3>
                  </div>
