...
WITH category_bovinas AS (
  SELECT id FROM categories WHERE name = 'Carnes Bovinas'
),
category_combos AS (
  SELECT id FROM categories WHERE name = 'Combos Churrascaria'
)
